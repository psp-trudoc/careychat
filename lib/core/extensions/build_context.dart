...
extension BuildContextExtension on BuildContext {
  ...
  //     currentDate: now,
  //     locale: locale ?? AppLocale.ar.instance,
  //     confirmText: "Select",
  //     cancelText: "Cancel",
  //   );
  // }
  ...
  Future<T?> showBottomSheet<T>({
    ...
    return showModalBottomSheet<T?>(
      ...
      backgroundColor: color ?? theme.bottomSheetTheme.backgroundColor,
      builder: (context) => child,
    );
  }

  Future<T?> showCupertinoActionBottomSheet<T>({
  ...
  ///
  /// **Highly recommended** the widget is passed on `child` should use with baseAlertWidget.
